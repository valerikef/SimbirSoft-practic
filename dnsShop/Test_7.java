...
public class Test_7 extends ChromeDriverSettings implements List
{
    //Добавление тована в сравнение и очистка списка сравнения
    @Test
    public void Test() {
        ...
        sleep();
        //Очистка сравнения
        chromeDriver.findElement(By.className(clear_app)).click();
    }
}
